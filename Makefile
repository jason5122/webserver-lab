...
OBJS = wserver.o wclient.o request.o io_helper.o request_heap.o
...
wserver: wserver.o request.o io_helper.o request_heap.o
	$(CC) $(CFLAGS) -o wserver wserver.o request.o io_helper.o request_heap.o
